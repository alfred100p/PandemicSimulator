...
class Base_Agent(object):
    ...
    def get_score_required_to_win(self):
        ...
        if self.environment_title == "PandemicGym": return 0
    ...
    def get_trials(self):
        ...
        elif self.environment_title == "PandemicGym":
            return 30
        try: 
    ...
    def conduct_action(self, action,rnd=False):
        ...
        if rnd:
            self.next_state, self.reward, self.done, _ = self.environment.rstep(action)
    ...
    def create_NN(self, input_dim, output_dim, key_to_use=None, override_seed=None, hyperparameters=None, load=False,name=''):
        ...
        if load: 
            ...
            net2.load_state_dict(torch.load("/u/alfredwj/home/a0/346{}_network.pt".format(self.agent_name+name)))
        return net2
