...
class Trainer(object):
    ...
    def run_games_for_agents(self):
        ...
        #plt.show()
        plt.savefig(os.path.dirname(os.getcwd())+'/plots/b.png')
        return self.results
    ...
    def visualise_preexisting_results(self, save_image_path=os.path.dirname(os.getcwd())+'/plots/a.png', data_path=None, colors=None, show_image=True, ax=None,
    ...
    def visualise_set_of_preexisting_results(self, results_data_paths, save_image_path=os.path.dirname(os.getcwd())+'/plots/a.png', show_image=True, plot_titles=None,
                                             y_limits=[None,None]):
