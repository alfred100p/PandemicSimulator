...
class InfectionSummaryAboveThresholdDone(DoneFunction):
    ...
    def __init__(self, threshold: float, *args: Any, **kwargs: Any):#summary_type: InfectionSummary, *args: Any, **kwargs: Any):
        super().__init__(*args, **kwargs)
    ...
    def calculate_done(self, obs: PandemicObservation, action: int) -> bool:
        return bool(np.any(obs.global_infection_summary[..., -1,1] > self._threshold))
